...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  // ===== P2 Third-Party / Aggregator Relay Presets =====
  // Priority: Multi-endpoint candidates first
  ...
  },
  {
    ...
    websiteUrl: "https://s.qiniu.com",
    apiKeyUrl: "https://s.qiniu.com",
  ...
  },
  {
    ...
    endpointCandidates: ["https://api.teamorouter.cn", "https://api.teamorouter.com"],
    category: "aggregator",
    priority: 5,
    defaultModel: "claude-sonnet-4.5",
    models: [],
  ...
  // Secondary P2 relays (single endpoint)
  {
    name: "A6API",
    provider: "custom",
  ...
  },
  {
    ...
    apiKeyUrl: "https://console.apito.ai/agent/register",
    category: "aggregator",
    priority: 5,
    defaultModel: "claude-sonnet-4.5",
    models: [],
  ...
  },
  {
    ...
    apiKeyUrl: "https://code0.ai/agent/register",
    category: "aggregator",
    priority: 5,
    defaultModel: "claude-sonnet-4.5",
    models: [],
